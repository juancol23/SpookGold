...
public class HolderMensajeStyle extends RecyclerView.ViewHolder {
    ...
    private LinearLayout chat_posicion;

    public HolderMensajeStyle(View itemView) {
        super(itemView);
        ...
        chat_posicion = (LinearLayout) itemView.findViewById(R.id.chat_posicion);
    }

    public LinearLayout getChat_posicion() {
        return chat_posicion;
    }

    public void setChat_posicion(LinearLayout chat_posicion) {
        this.chat_posicion = chat_posicion;
    }
